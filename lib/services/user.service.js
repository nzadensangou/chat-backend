...
export class UserService {
   ...
   */
  static async generateAvailablePhoneNumber(countryId) {
    // Get country prefix
    ...
    for (let attempt = 0; attempt < 10; attempt++) {
      const randomNum = Math.floor(Math.random() * 9000000) + 1000000; // 7-digit random
      const phoneNumber = `${country.prefix}${randomNum}`;
