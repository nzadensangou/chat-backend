...
export class CallService {
  static async initiateCall(callerId, payload) {
    ...
    const { receiverId, callType, room, plannedStartTime, plannedDurationSeconds } = validData;
  ...
  static async createMeeting(payload) {
    const { idOrganiser, receiverId, callType, room, objet, plannedStartTime, plannedDurationSeconds } = payload;
