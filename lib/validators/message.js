...
export class MessageValidator extends BaseValidator {
   ...
   * @returns {string} Valid message type (the messages.type column is VARCHAR,
   *   unlike meeting/participant/status tables which use integer codes —
   *   MESSAGE_TYPE_CODES must NOT be applied here).
